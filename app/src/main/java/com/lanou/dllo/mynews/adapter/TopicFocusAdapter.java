 ...
 */
public class TopicFocusAdapter extends FragmentPagerAdapter {
    private ArrayList<Fragment> data;
    private Context context;
    private String[] titles = {"我的关注", "我的发布"};

    public TopicFocusAdapter(FragmentManager fm, ArrayList<Fragment> data, Context context) {
        super(fm);
        this.data = data;
